...
echo "<h1>Generación de Datos de Prueba Completos</h1>";
...
try {
    ...
    echo "<h2>Verificando empleados existentes...</h2>";
    ...
    if ($countEmpleados < 10) {
        ...
        $insertEmpleado = $db->prepare("
            INSERT INTO empleados (
                ...
                dpi, nit, id_departamento, id_puesto,
                fecha_contratacion, salario_base, estado
            ) VALUES (
                :primer_nombre, :segundo_nombre, :primer_apellido, :segundo_apellido,
                :fecha_nacimiento, :email, :telefono, :direccion,
                :dpi, :nit, :id_departamento, :id_puesto,
                :fecha_contratacion, :salario_base, 'Activo'
            )
        ");
